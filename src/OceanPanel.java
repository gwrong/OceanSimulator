        ...
        for (int i = 0; i < currFishsSize; i++) {
            ...
            //don't want double reproduction
                if (fishies.get(i).collidesWithFish(fishies.get(j))) {
                    if (fishies.get(j) instanceof JellyFish
                                   && !(fishies.get(i) instanceof JellyFish)) {
                        fishies.get(i).zap();
                    } else if (fishies.get(i) instanceof JellyFish
                                   && !(fishies.get(j) instanceof JellyFish)) {
                        fishies.get(j).zap();
                    }
